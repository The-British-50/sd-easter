...
Config.easterBasket = {
    [1] = {
        name = "🐰 Small Easter Basket",
        item = "easterbasket_small",
        cost = 5,
        rewards = {
            {
                item = "chocolatebunny",
    ...
    [2] = {
        name = "🐰 Medium Easter Basket",
        item = "easterbasket_medium",
        cost = 10,
        rewards = {
            {
                item = "chocolatebunny",
    ...
    [3] = {
        name = "🐰 Large Easter Basket",
        item = "easterbasket_large",
        cost = 20,
        rewards = {
            {
                item = "chocolatebunny",
...
Config.text = {
    pickupEgg = "Pickup Egg.",
    actionEgg = "Picking up an egg.",
    openBox = "Opening Basket..",

    shopEgg = "Easter Egg Shop",
    shopTitle = " 🐰 Easter 🐰",
...
Config.easterEggs = {
    [1] = {
        location = vector3(213.78, -809.07, 32.92),
        heading = 334.49,
        model = "bzzz_event_easter_egg_a"
    },
    [2] = {
        location = vector3(230.88, -758.58, 29.87),
        heading = 329.56,
        model = "bzzz_event_easter_egg_b"
    },
    [3] = {
        location = vector3(-595.24, 529.8, 105.76),
        heading = 25.16,
        model = "bzzz_event_easter_egg_c"
    },
    [4] = {
        location = vector3(225.28, -740.84, 33.28),
        heading = 21.52,
        model = "bzzz_event_easter_egg_d"
    },
    [5] = {
        location = vector3(298.22, -586.71, 42.26),
        heading = 202.97,
        model = "bzzz_event_easter_egg_e"
    },
    [6] = {
        location = vector3(343.29, -593.86, 28.7),
        heading = 312.66,
        model = "bzzz_event_easter_egg_b"
    },
    [7] = {
        location = vector3(369.42, -599.97, 27.87),
        heading = 36.34,
        model = "bzzz_event_easter_egg_a"
    },
    [8] = {
        location = vector3(-1095.53, 601.0, 101.06),
        heading = 28.36,
        model = "bzzz_event_easter_egg_a"
    },
    [9] = {
        location = vector3(418.1, -811.98, 28.31),
        heading = 105.37,
        model = "bzzz_event_easter_egg_e"
    },
    [10] = {
        location = vector3(-1455.21, 534.46, 117.37),
        heading = 75.92,
        model = "bzzz_event_easter_egg_a"
    },
    [11] = {
        location = vector3(391.3, -771.35, 28.28),
        heading = 44.19,
        model = "bzzz_event_easter_egg_c"
    },
    ---left offf
